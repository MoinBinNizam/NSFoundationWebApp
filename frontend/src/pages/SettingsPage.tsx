...
export const SettingsPage: React.FC = () => {
  ...
  const loadSettings = useCallback(async () => {
    setLoading(true);
    try {
      const [shareRes, ruleRes, waiverRes, gatewayRes] = await Promise.all([
    ...
    try {
      await apiRequest('/settings/gateway-rates', {
        ...
        body: JSON.stringify({
          ...
          roundingIncrement: Number(editingGateway.roundingIncrement),
